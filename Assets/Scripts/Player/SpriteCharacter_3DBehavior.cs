...
public class SpriteCharacter_3DBehavior : MonoBehaviour
{
    ...
    //[Space(-19)]
    //[Header("  ６  웃  ２")]
    //[Space(-19)]//------------------------------------------[this is just a small graphic to explain the logic of the script, it makes more sense in the unity inspector interface]
    ...
    public bool use4Directions = true;//----------------------------------------------[if true you can render a character with only 4 directions instead of 8]
    ...
    //⦿
    void OnValidate()
    {//-----------------------------------[this is just to assing some values at the beggining in the unity editor]
    ...
    {//--------------------------------------[check if in the animator controller has any parameter to work with]
    ...
    {//-----------------------------------------------------------[CALCULATING FACING DIRECTIONS]
        ...
        {//⦿─────────────────────────────────────[here the 4 directions are assigned, and if its to the right or the left]─────────────────────────────────────────────────────────────────────────────
